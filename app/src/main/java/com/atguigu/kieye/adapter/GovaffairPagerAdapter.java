...
public class GovaffairPagerAdapter extends RecyclerView.Adapter<GovaffairPagerAdapter.ViewHolder> {
    ...
    //构造器
    public GovaffairPagerAdapter(Context context, final List<ShoppingCart> datas, final CheckBox checkbox_all, TextView tv_total_price) {
