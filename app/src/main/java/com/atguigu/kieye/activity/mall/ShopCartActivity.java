...
import com.atguigu.kieye.adapter.GovaffairPagerAdapter;
import com.atguigu.kieye.bean.ShoppingCart;
import com.atguigu.kieye.pay.PayResult;
import com.atguigu.kieye.pay.SignUtils;
...
public class ShopCartActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.govaffair_pager);
...
//设置删除按钮的点击事件
            ...
            btn_order.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(ShopCartActivity.this, "点击了去结算！！", Toast.LENGTH_SHORT).show();
                }
            });

            //将数据库中的数据显示在recyclerView上
            setAdapter();
        }
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        Toast.makeText(ShopCartActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                    } else {
                        // 判断resultStatus 为非"9000"则代表可能支付失败
                        // "8000"代表支付结果因为支付渠道原因或者系统原因还在等待支付结果确认，最终交易是否成功以服务端异步通知为准（小概率状态）
                        if (TextUtils.equals(resultStatus, "8000")) {
                            Toast.makeText(ShopCartActivity.this, "支付结果确认中", Toast.LENGTH_SHORT).show();

                        } else {
                            // 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
                            Toast.makeText(ShopCartActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
