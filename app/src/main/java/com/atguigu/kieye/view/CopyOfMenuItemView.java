...
import com.atguigu.kieye.utils.PhoneUtils;
import com.nineoldandroids.animation.Animator;
import com.nineoldandroids.animation.ObjectAnimator;
import com.nineoldandroids.view.ViewHelper;

@TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
public class CopyOfMenuItemView extends RelativeLayout implements OnClickListener{
	...
	public CopyOfMenuItemView(Context context) {
		this(context, null);
	}
	public CopyOfMenuItemView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	public CopyOfMenuItemView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(AttributeSet attrs){
		...
		backgroundSourceId = ta.getResourceId(R.styleable.MenuItemView_mbackground, -1);
		...
		mRippleColor = ta.getColor(R.styleable.MenuItemView_mrippleColor,mRippleColor);
		...
		default:
            ...
            mRadiusAnimator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                	setRadius(0);
                    ViewHelper.setAlpha(CopyOfMenuItemView.this, 1);
                }
